    ...
    if (contactNode != null) {
      ...
      if (contactNode.isArray()) {
        for (JsonNode contact : contactNode) {
          OrganizationalContact author = mapper.convertValue(contact, OrganizationalContact.class);
          contacts.add(author);
        }
      }
      else if (contactNode.isObject()) {
        OrganizationalContact author = mapper.convertValue(contactNode, OrganizationalContact.class);
        contacts.add(author);
      }
